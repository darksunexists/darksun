...
export const DEFAULT_MAX_INVESTIGATE_TWEET_LENGTH = 500;
...
export const twitterEnvSchema = z.object({
    ...
    MAX_INVESTIGATE_TWEET_LENGTH: z.number().int().default(DEFAULT_MAX_TWEET_LENGTH),
...
export async function validateTwitterConfig(
    ...
    try {
        const twitterConfig = {
            ...
            MAX_INVESTIGATE_TWEET_LENGTH: // number as string?
                safeParseInt(
                    runtime.getSetting("MAX_INVESTIGATE_TWEET_LENGTH") ||
                    process.env.MAX_INVESTIGATE_TWEET_LENGTH
                , DEFAULT_MAX_INVESTIGATE_TWEET_LENGTH),
